...
public class StorageRest {
    ...
    public ResponseEntity<Collection<Storage>> listAllStorages() {
        logger.debug("Creating all Storage instances");
        return new ResponseEntity<>(HttpStatus.NOT_IMPLEMENTED);
    }


    //-------------------Retrieve Single Storage--------------------------------------------------------

    @RequestMapping(value = "{name}", method = RequestMethod.GET, produces = MediaType.APPLICATION_JSON_VALUE)
    public ResponseEntity<Storage> getStorage(@PathVariable("name") String name) {
        logger.debug("Get Storage ");
        return new ResponseEntity<>(HttpStatus.NOT_IMPLEMENTED);
    ...
    public ResponseEntity<Storage> deleteStorage(@PathVariable("name") String name) {
        logger.debug("Fetching & Deleting Storage with name " + name);
        return new ResponseEntity<>(HttpStatus.NOT_IMPLEMENTED);
    }
    ...
    public ResponseEntity<Storage> deleteAllStorages() {
        logger.debug("Deleting All Storages");
        return new ResponseEntity<>(HttpStatus.NOT_IMPLEMENTED);
    }
