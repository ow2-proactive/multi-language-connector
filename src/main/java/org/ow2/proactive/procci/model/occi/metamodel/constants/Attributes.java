...
public class Attributes {
    ...
    public static final Attribute TERM = new Attribute.Builder(TERM_NAME, Type.OBJECT, true,
            false).description(
            "Unique identifier of the Category instance " +
                    "within the categorization scheme.").build();
    public static final Attribute SCHEME = new Attribute.Builder(SCHEME_NAME, Type.OBJECT, true,
            false).description("The categorization scheme.").build();
    public static final Attribute CATEGORY_TITLE = new Attribute.Builder(CATEGORY_TITLE_NAME, Type.OBJECT,
            false,
    ...
    public static final Attribute KIND = new Attribute.Builder(KIND_NAME, Type.OBJECT, true,
            false).description(
    ...
    public static final Attribute MIXINS = new Attribute.Builder(MIXINS_NAME, Type.LIST, false,
    ...
    public static final Attribute KIND_ACTIONS = new Attribute.Builder(KIND_ACTIONS_NAME, Type.LIST, false,
            false).description("List of Action instances defined by the Kind instances").build();
    public static final Attribute PARENT = new Attribute.Builder(PARENT_NAME, Type.OBJECT, false,
            false).description("Another Kind instance which this Kind has an " +
            "inheritance relationship with.").build();
    public static final Attribute KIND_ENTITIES = new Attribute.Builder(KIND_ENTITIES_NAME, Type.LIST,
            false,
    ...
    public static final Attribute SOURCE = new Attribute.Builder(SOURCE_NAME, Type.OBJECT, true,
            true).description("The Resource instances the Link instance " +
            "originates from.").build();
    public static final Attribute TARGET = new Attribute.Builder(TARGET_NAME, Type.OBJECT, true,
            true).description("The unique identifier of an Object this " +
            "Link instance points to.").build();
    public static final Attribute TARGET_KIND = new Attribute.Builder(TARGET_KIND_NAME, Type.OBJECT,
            false,
            true).description("The Kind of target, if applicable.").build();
    public static final Attribute MIXIN_ACTIONS = new Attribute.Builder(MIXIN_ACTIONS_NAME, Type.LIST,
            false,
            false).description("List of Action instances defined by" +
            "the Mixin instance.").build();
    public static final Attribute DEPENDS = new Attribute.Builder(DEPENDS_NAME, Type.LIST, false,
            false).description("List of Mixin instances this Mixin" +
            "instance depends on.").build();
    public static final Attribute APPLIES = new Attribute.Builder(APPLIES_NAME, Type.LIST, false,
            false).description("List of Kind instances this Mixin" +
            "instance applies to.").build();
    public static final Attribute MIXIN_ENTITIES = new Attribute.Builder(MIXIN_ENTITES_NAME, Type.LIST,
            false,
            true).description("List of Entity instances associated" +
            "with the Mixin instance.").build();
    public static final Attribute LINKS = new Attribute.Builder(LINKS_NAME, Type.LIST, false,
            true).description(
